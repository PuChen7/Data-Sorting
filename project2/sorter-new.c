...
void *sort_one_file(void* ArgsForSorting){
    struct ArgsForSorting* sortArgs = (struct ArgsForSorting*) ArgsForSorting;
...
void *recur(void *ArgsForRecur){
    pthread_t waittid[10000];
    int countthread = 0, i, localcounter = 0, chunk = 512, joined = 0;
    
    struct ArgsForRecur* recurArgs = (struct ArgsForRecur*) ArgsForRecur;
